...
<body>
    ...
    <div id="list1" class="hidden grid md:grid-cols-3 grid-cols-1">
        ...
        <div class="h-[59em] md:w-3/4 lg:w-full
            ...
            <img src='./images/hospital.png' alt="" class="h-full">
        </div>
            ...
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                ...
                <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="hospitalLogin.php" method="post">
                        ...
                        <button type="submit"
                            class="w-full text-white bg-blue-600 hover:bg-[#32B4D0] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "><i class="fa-brands fa-google"></i> Continue With Google</button>
                            <a type="submit" href="index.html"
                            class="w-full text-white bg-blue-600 hover:bg-[#32B4D0] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "><i class="fa-brands fa-google"></i> Sign In as a member</a>
                       

                            <p class="text-sm font-light text-gray-800 ">
                            Don’t have an account yet? <a href="signup_hospital.php"
