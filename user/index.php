...
<body>
    ...
    <section class="home w-full" style="height: 100%;">
        ...
        <div class="px-16 mt-5 text">
            ...
            <div class="grid grid-cols-5 text-center gap-5 -mt-[500px]">
                        <div><a href="disease-speech.php"><button class="services flex flex-col justify-center items-center p-7 h-96">
                           ...
                           <p class="px-5 py-2 rounded-xl bg-white my-5">Enter</p>
                        </button></a>
                        </div>
                        <div>
                        <a href="disease-text.php"><button class="services flex flex-col justify-center items-center p-7 h-96">
                            <h1>Disease Prediction with Text</h1>
                           <img src="./images/speech prediction.png" alt="">
                           <p class="px-5 py-2 rounded-xl bg-white my-5">Enter</p>
                        </button></a>
                        </div>
                        <div>
                        <a href="history.php"><button class="services flex flex-col justify-center items-center p-7 h-96">
                            <h1>Predicted History of Diseases</h1>
                           <img src="./images/history.png" alt="">
                           <p class="px-5 py-2 rounded-xl bg-white my-5">Enter</p>
                        </button></a>
                        </div>
                        <div>
                        <a href="nearby-doctor.php"><button class="services flex flex-col justify-center items-center p-7 h-96">
                            <h1>Explore Nearby Specialized Doctor </h1>
