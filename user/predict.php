...
<body>
    ...
    <section class="home" style="height: 100%;">
        ...
        <div class="px-16 mt-5 text">
            ...
            $text = $_POST['record_text'];

            $command = escapeshellcmd("python pythonfile.py $text");

            $output = shell_exec($command);

            echo '<h1 class="text-4xl text-blue-700">Your predicted disease is:[<span class="text-red-700"> '.$output.'</span> ]</h1>';
            $id = $_SESSION['id'];
            ...
            <div class="flex gap-10 justify-around mt-14">
                <a href="specialized.php?disease=<?php echo $output?>"><button class="bg-[#6748E3] text-white text-xl px-5 py-2 rounded-xl">View Specialized Doctor</button></a>
                <a href="primary-medication.php?disease=<?php echo $output?>"><button class="bg-[#FD6D2F] text-white text-xl px-5 py-2 rounded-xl">View Primary Medication</button></a>
            </div>
