...
<body>
    ...
    <div id="list1" class="hidden grid md:grid-cols-3 grid-cols-1">
        ...
        <form action="signupAction.php" method="post" enctype="multipart/form-data">
            ...
            <h1 class="font-bold md:text-5xl text-2xl">User Signup</h1>
            ...
            <div class="mt-5">
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <label for="firstName"
                            class="peer-focus:font-medium absolute text-sxl text-gray-800 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-gray-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">First
                            Name</label>
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <label for="dateOfBirth"
                            class="peer-focus:font-medium absolute text-sxl text-gray-800 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-gray-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Date
                            Of Birth</label>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="lastName" id="lastName"
                            ...
                            placeholder=" " required />
                        <label for="lastName"
                            class="peer-focus:font-medium absolute text-sxl text-gray-800 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-gray-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Last
                            Name</label>
        ...
        <div class="lg:flex justify-between items-center mt-14">
            <div>
                <a href="" class="w-full bg-[#956EC6] text-white py-3 rounded-xl text-xl font-bold px-14 cursor-pointer">Sign Up As A Hospital</a>
        ...
        <div class="bg-[url(./images/doctor_bg.png)] bg-no-repeat h-[59em] md:w-3/4 lg:w-full md:bg-contain lg:bg-cover"> 
          <img src='./images/doctor.png' alt="" class="h-[45em] mt-56 ml-14">
        </div>
